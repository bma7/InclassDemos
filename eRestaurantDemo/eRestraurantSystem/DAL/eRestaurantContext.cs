...
using eRestraurantSystem.DAL.Entities;
//using System.ComponentModel.DataAnnotations;
using System.Data.Entity;

#endregion

namespace eRestraurantSystem.DAL
{
    //this class should onlu be accessiable from classes inside this component library
    //thereforce the access level for this class will be internal
    ...
    internal class eRestaurantContext : DbContext
    {
        ...
        //when overriding the OnModelCreating(), it is important to remember to call the base method"s implementation brfore you exit the method

        //the ManyToManyNavigationPropertyConfiguration.Map method lets you configure the tables and columns used for this many to many relationship
        ...
        //this technique should ONLY be used if the associate table in sql has ONLY a compound primary key and NO non-key attributes
